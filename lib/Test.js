...
function Test(moduleName, // @arg String: target module.
              param) {    // @arg Object(= {}): { disable, browser, worker, node, button, both }
                          ...
                          // @help: Test
//{@dev
    _if(!Valid.type(param, "Object"), Test, "param");
    _if(!Valid.keys(param, "disable,browser,worker,node,button,both"), Test, "param");
//}@dev
    ...
    function _next() {
        ...
        if (fn) {
            ...
            try {
                ...
                _missLogger(order, "Catch " + o_O.message + " in " + itemName);
                nextObject = null;
                task.miss();
            }
        }
